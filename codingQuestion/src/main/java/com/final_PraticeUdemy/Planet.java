...
public class Planet {
    ...
    public Planet(String name, int size, double closestStarDistance, int temperature,
                  String type, double distanceFromEarth) {
        this.name = name;
        this.size = size;
    ...
    public boolean equals(Object o) {
        ...
        return size == planet.size && Double.compare(closestStarDistance,
                planet.closestStarDistance) == 0 && temperature == planet.temperature &&
                Double.compare(distanceFromEarth, planet.distanceFromEarth) == 0
                && Objects.equals(name, planet.name) && Objects.equals(type, planet.type);
    }
